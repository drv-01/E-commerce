    ...
    <div className="bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {fashionItems.map((item) => (
          <div key={item.id} className="bg-white rounded-2xl shadow-md hover:shadow-lg transition duration-300">
            <img
              src={item.thumbnail}
              alt={item.title}
            ...
            <div className="p-4">
              <div className="flex justify-between items-start">
                ...
                <span className="bg-red-100 text-red-600 text-xs px-2 py-1 rounded">-{item.discountPercentage}%</span>
              </div>
